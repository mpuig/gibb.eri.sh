...
impl RouterState {
    /// Create a new RouterState with skills loaded.
    pub fn with_skills(skills: &SkillManager) -> Self {
        ...
        tracing::info!(
            ...
            "Router initialized with skills"
        );
    ...
    /// Update from a registry.
    pub fn update_with_registry(&mut self, registry: &ToolRegistry, mode: Mode) {
