...
export function MicIcon({ className = "w-4 h-4", strokeWidth = 2 }: IconProps) {
  return (
...
export function GearIcon({ className = "w-4 h-4", strokeWidth = 2 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={strokeWidth}>
      <path
        strokeLinecap="round"
...
export function SearchIcon({ className = "w-4 h-4", strokeWidth = 2 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={strokeWidth}>
...
export function PencilIcon({ className = "w-4 h-4", strokeWidth = 2 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={strokeWidth}>
      <path
        strokeLinecap="round"
